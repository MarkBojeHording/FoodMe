...
file4 = URI.open("https://media.istockphoto.com/id/1314976610/id/foto/kodok-di-dalam-lubang.jpg?s=612x612&w=0&k=20&c=V8ZAtH_27aFXG3fNeyOuCvbdiKVFTJdp1NW1xFHJojo=")

puts "About to attach images..."
Dish.first.photos.attach(io: file1, filename: "toad.png", content_type: "image/png")
Dish.first.photos.attach(io: file4, filename: "toad.png", content_type: "image/png")
puts "1 done..."
Dish.second.photo.attach(io: file2, filename: "cheeseburger.png", content_type: "image/png")
puts "2 done..."
Dish.third.photo.attach(io: file3, filename: "sushi.png", content_type: "image/png")
